!(function (o) {
	o.fn.YouTubePopUp = function (e) {
		...
		o(this).on("click", function (e) {
			...
			o("body").append(
				'<div class="YouTubePopUp-Wrap YouTubePopUp-animation"><div class="YouTubePopUp-Content"><span class="YouTubePopUp-Close"></span> <iframe width="560" height="315" src="https://www.youtube.com/embed/Jy7Kr2AyBeM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> </div></div>'
			),
